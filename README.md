# CarCareTracker - Version Personnalisée pour la Tunisie 🇹🇳

> **Note**: Ce projet est basé sur [LubeLogger](https://lubelogger.com) et a été personnalisé pour un usage en Tunisie avec support du Dinar Tunisien et interface en français.

## 📋 Modifications Personnalisées

✅ **Langue par défaut**: Français (`fr_FR`)  
✅ **Devise**: Dinar Tunisien (TND) - Locale `fr-TN`  
✅ **Interface épurée**: Suppression des sponsors, mentions externes, et promotions  
✅ **Branding propre**: Prêt pour votre personnalisation

📖 **Guide complet**: Voir [PERSONNALISATION.md](./PERSONNALISATION.md) pour les détails et instructions de personnalisation.
